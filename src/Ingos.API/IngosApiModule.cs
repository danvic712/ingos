...
using System.IO;
using System.Linq;
using Ingos.API.Infrastructure;
using Ingos.Application;
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                foreach (var apiVersion in apiVersionList)
                    options.SwaggerEndpoint($"/swagger/{apiVersion}/swagger.json",
                        $"Ingos API {apiVersion?.ToUpperInvariant()}");
            });
        ...
        private static void ConfigureSwagger(ServiceConfigurationContext context)
        {
            context.Services.AddSwaggerGen(
                options =>
                {
                    ...
                    {
                        @"wwwroot/api-doc/Ingos.API.xml",
                        @"wwwroot/api-doc/Ingos.Application.xml",
                        @"wwwroot/api-doc/Ingos.Application.Contracts.xml"
                    };
